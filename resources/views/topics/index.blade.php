...
@section('content')
    ...
    {{-- <h1>Add Class</h1> --}}
                    ...
                    <div class="container-fluid">
                            ...
                            {!! Form::open(['name' => 'list', 'action' => 'TopicsController@list', 'method' => 'POST']) !!}
                                @if(Auth::user()->type == 3)
    ...
    // $("select[name='department']").change(function(){
        ...
        $("select[name='year']").change(function(){
            ...
            $("select[name='batch']").change(function(){
                // console.log("in bathc");
                var id = $(this).val();
                // console.log(id);
                $.ajax({
                    url: "<?php echo route('ajax-call') ?>",
                    method: 'POST',
                    // data: {department:department, year:year, batch:batch, _token:token},
