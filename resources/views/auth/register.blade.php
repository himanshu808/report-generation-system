            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                                {{ Form::label('type','Type',['class' => "col-md-4 col-form-label text-md-right"])}}
                                <div class="col-md-6">
                                    {{ Form::select('type', ['1' => 'Teacher', '2' => 'HOD', '3' => 'Admin'], null, ['class' => 'form-control', 'placeholder' => 'Select Type']) }}
                                </div>
                        </div>
